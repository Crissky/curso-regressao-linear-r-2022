...
attach(tab15_1)
View(tab15_1)  # Visualiza Tabela
tab15_1  # Visualiza Tabela no console
...
## Estatística descritiva do tempo de reação por idade
...
boxplot(tempo_Y~idade_X,
        ...
        main="Boxplot do tempo em relação a idade")
